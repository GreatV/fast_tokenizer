...
inline void GetUTF8Str(const char32_t* unicode_str, char* utf8_str,
                       size_t unicode_len) {
  char dst_char[5] = {0};
...
inline void GetUnicodeStr(const char* pSrc, char32_t* unicode_str,
                          size_t unicode_len) {
...
inline bool IsValidDecodeUTF8(const char* begin, const char* end,
                              size_t* mblen) {
