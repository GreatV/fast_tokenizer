...
struct FASTTOKENIZER_DECL SpecialToken {
  ...
  SpecialToken(const std::string& id, const std::vector<uint32_t>& ids,
...
struct FASTTOKENIZER_DECL TemplatePostProcessor : public PostProcessor {
  ...
  TemplatePostProcessor(const Template&, const Template&,
  ...
  void ApplyTemplate(const Template& pieces, core::Encoding* encoding,
