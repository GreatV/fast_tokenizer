...
BPE::BPE(const core::Vocab& vocab, const core::Merges& merges,
         size_t cache_capacity, const std::vector<float>& dropout,
         const std::vector<std::string>& unk_token,
         const std::vector<std::string>& continuing_subword_prefix,
         const std::vector<std::string>& end_of_word_suffix, bool fuse_unk)
    : vocab_(vocab),
      fuse_unk_(fuse_unk),
      dropout_(dropout),
...
void BPE::GetVocabAndMergesFromFile(const std::string& vocab_json_path,
                                    ...
                                    core::Vocab* vocab, core::Merges* merges) {
