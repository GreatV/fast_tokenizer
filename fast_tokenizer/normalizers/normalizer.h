...
class FASTTOKENIZER_DECL NormalizedString {
 public:
  ...
  bool Slice(core::Range range, NormalizedString* normalized,
  ...
  void Split(const PatternType&
             ...
             core::SplitMode mode, std::vector<NormalizedString>* normalizes,
 ...
 private:
  ...
  void UpdateNormalizedRange(const OffsetMapping& new_normalized,
                             uint32_t initial_offset, const core::Range& range,
  ...
  uint32_t GetMatch(const std::string& normalized, const re2::RE2& pattern,
                    std::vector<std::pair<core::Range, bool>>* matches,
                    bool invert = false) const;
