...
void BindCore(pybind11::module* m) {
  ...
  py::class_<core::Encoding>(*m, "Encoding")
      .def(py::init<
               ...
               const std::vector<std::string>&, const std::vector<uint32_t>&,
               const std::vector<core::Offset>&, const std::vector<uint32_t>&,
               const std::vector<uint32_t>&, const std::vector<core::Encoding>&,
               const std::unordered_map<uint32_t, core::Range>&>(),
           py::arg("ids"), py::arg("type_ids"), py::arg("tokens"),
           py::arg("words_idx"), py::arg("offsets"),
           py::arg("special_tokens_mask"), py::arg("attention_mask"),
           py::arg("overflowing"), py::arg("sequence_ranges"))
      .def(py::init<uint32_t>(), py::arg("size"))
      .def(py::init<const std::vector<core::Token>&, uint32_t>(),
           py::arg("tokens"), py::arg("type_id"))
      ...
      .def("set_sequence_ids", &core::Encoding::SetSequenceIds,
           py::arg("sequence_id"))
      .def(
          "char_to_token",
          [](const core::Encoding& self, uint32_t char_pos,
          ...
          py::arg("char_pos"), py::arg("sequence_index") = 0)
      .def(
          "char_to_word",
          [](const core::Encoding& self, uint32_t char_pos,
             uint32_t seq_id) -> py::object {
          ...
          py::arg("char_pos"), py::arg("sequence_index") = 0)
      .def_static("merge", &core::Encoding::Merge, py::arg("encodings"),
                  py::arg("growing_offsets") = true)
      .def(
          "pad",
          [](core::Encoding& self, uint32_t length,
             const std::string& direction, uint32_t pad_id,
             uint32_t pad_type_id, const std::string& pad_token) {
          ...
          py::arg("length"), py::arg("direction") = "right",
          py::arg("pad_id") = 0, py::arg("pad_type_id") = 0,
      ...
      .def(
          "word_to_chars",
          [](const core::Encoding& self, uint32_t word_index,
             uint32_t sequence_index) -> py::object {
            auto ranges = self.WordIdxToCharOffsets(word_index, sequence_index);
            if (ranges.size() == 0) {
              return py::none();
            }
            return py::cast(ranges[0]);
          },
          py::arg("word_index"), py::arg("sequence_index") = 0)
      .def(
          "word_to_tokens",
          [](const core::Encoding& self, uint32_t word_index,
             uint32_t sequence_index) -> py::object {
      ...
      .def(
          "truncate",
          [](core::Encoding& self, size_t max_length, size_t stride,
          ...
          py::arg("max_length"), py::arg("stride") = 0,
          py::arg("direction") = "right");

  py::class_<core::AddedToken>(*m, "AddedToken")
      .def(py::init<>())
      .def(py::init([](const std::string& content, bool single_word,
                       bool lstrip, bool rstrip, bool normalized) {
             return core::AddedToken(content, !normalized, single_word, lstrip,
                                     rstrip);
           }),
           py::arg("content"), py::arg("single_word") = false,
           py::arg("lstrip") = false, py::arg("rstrip") = false,
