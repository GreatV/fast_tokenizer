...
static int TokenizerPropertiesSetModel(TokenizerObject* self, PyObject* value,
                                       void* closure) {
  TOKENIZERS_TRY
  py::handle py_obj(value);
  int ret = 0;
...
static PyObject* TokenizerPropertiesGetPadding(TokenizerObject* self,
  ...
  PyDict_SetItem(py_dict, ToPyObject("pad_token_type_id"),
                 ToPyObject(pad_method.pad_token_type_id_));
  PyDict_SetItem(py_dict, ToPyObject("pad_token"),
                 ToPyObject(pad_method.pad_token_));
  if (pad_method.pad_to_multiple_of_ > 0) {
    PyDict_SetItem(py_dict, ToPyObject("pad_to_multiple_of"),
  ...
  if (pad_method.strategy_ == core::PadStrategy::BATCH_LONGEST) {
    ...
    PyDict_SetItem(py_dict, ToPyObject("length"),
                   ToPyObject(pad_method.pad_len_));
  }
  return py_dict;
}
...
static PyObject* TokenizerPropertiesGetTruncation(TokenizerObject* self,
  ...
  PyObject* py_dict = PyDict_New();
  PyDict_SetItem(py_dict, ToPyObject("max_length"),
                 ToPyObject(trunc_method.max_len_));
  PyDict_SetItem(py_dict, ToPyObject("stride"),
                 ToPyObject(trunc_method.stride_));
  PyDict_SetItem(
      py_dict, ToPyObject("direction"),
      ToPyObject((trunc_method.direction_ == core::Direction::RIGHT) ? "right"
                                                                     : "left"));
  if (trunc_method.strategy_ == core::TruncStrategy::LONGEST_FIRST) {
    PyDict_SetItem(py_dict, ToPyObject("strategy"),
                   ToPyObject("longest_first"));
...
static int TokenizerPropertiesSetDecoder(TokenizerObject* self, PyObject* value,
                                         void* closure) {
  TOKENIZERS_TRY
  py::handle py_obj(value);
  int ret = 0;
...
struct PyGetSetDef tokenizer_variable_properties[] = {
    {"normalizer", (getter)TokenizerPropertiesGetNormaizer,
     (setter)TokenizerPropertiesSetNormalizer, nullptr, nullptr},
    {"pretokenizer", (getter)TokenizerPropertiesGetPreTokenizer,
     (setter)TokenizerPropertiesSetPreTokenizer, nullptr, nullptr},
    {"model", (getter)TokenizerPropertiesGetModel,
     (setter)TokenizerPropertiesSetModel, nullptr, nullptr},
    {"postprocessor", (getter)TokenizerPropertiesGetPostProcessor,
     (setter)TokenizerPropertiesSetPostProcessor, nullptr, nullptr},
    {"padding", (getter)TokenizerPropertiesGetPadding, nullptr, nullptr,
     nullptr},
    {"truncation", (getter)TokenizerPropertiesGetTruncation, nullptr, nullptr,
     nullptr},
    {"decoder", (getter)TokenizerPropertiesGetDecoder,
     (setter)TokenizerPropertiesSetDecoder, nullptr, nullptr},
...
static PyObject* AddSpecialTokens(TokenizerObject* self, PyObject* args,
                                  PyObject* kwargs) {
  TOKENIZERS_TRY
  PyObject* kw_special_tokens = NULL;
  static char* kwlist[] = {const_cast<char*>("tokens"), NULL};
  bool flag_ = PyArg_ParseTupleAndKeywords(args, kwargs, "|O", kwlist,
                                           &kw_special_tokens);
  Py_ssize_t args_num = PyTuple_Size(args);
  std::string tokens;
...
static PyObject* AddTokens(TokenizerObject* self, PyObject* args,
                           PyObject* kwargs) {
  TOKENIZERS_TRY
...
static PyObject* EnablePadding(TokenizerObject* self, PyObject* args,
                               PyObject* kwargs) {
  TOKENIZERS_TRY
  ...
  bool flag_ = PyArg_ParseTupleAndKeywords(
      args, kwargs, "|OOOOOO", kwlist, &kw_direction, &kw_pad_id,
      &kw_pad_type_id, &kw_pad_token, &kw_length, &kw_pad_to_multiple_of);
  Py_ssize_t args_num = PyTuple_Size(args);
  ...
  self->tokenizer.EnablePadMethod(pad_direction, pad_id, pad_type_id, pad_token,
                                  length_ptr, pad_to_multiple_of_ptr);
  Py_RETURN_NONE;
  TOKENIZERS_CATCH_AND_THROW_RETURN_NULL
}

// def disable_padding()
static PyObject* DisablePadding(TokenizerObject* self, PyObject* args,
                                PyObject* kwargs) {
  TOKENIZERS_TRY
  Py_ssize_t args_num = PyTuple_Size(args);
...
// direction="right")
static PyObject* EnableTruncation(TokenizerObject* self, PyObject* args,
                                  PyObject* kwargs) {
  TOKENIZERS_TRY
  ...
  if (kwargs) flag_kwargs = true;
  static char* kwlist[] = {
      const_cast<char*>("max_length"), const_cast<char*>("stride"),
      const_cast<char*>("strategy"), const_cast<char*>("direction"), NULL};
  bool flag_ =
      PyArg_ParseTupleAndKeywords(args, kwargs, "|OOOO", kwlist, &kw_max_length,
                                  &kw_stride, &kw_strategy, &kw_direction);
  Py_ssize_t args_num = PyTuple_Size(args);
  ...
  self->tokenizer.EnableTruncMethod(max_length, stride, trunc_direction,
                                    trunc_strategy);
  Py_RETURN_NONE;
  TOKENIZERS_CATCH_AND_THROW_RETURN_NULL
}
...
static PyObject* DisableTruncation(TokenizerObject* self, PyObject* args,
                                   PyObject* kwargs) {
  TOKENIZERS_TRY
  Py_ssize_t args_num = PyTuple_Size(args);
  if (args_num == (Py_ssize_t)0) {
...
static PyObject* GetVocabSize(TokenizerObject* self, PyObject* args,
                              PyObject* kwargs) {
  TOKENIZERS_TRY
  PyObject* kw_with_added_vocabulary = NULL;
  static char* kwlist[] = {const_cast<char*>("with_added_vocabulary"), NULL};
...
static PyObject* Encode(TokenizerObject* self, PyObject* args,
                        PyObject* kwargs) {
  TOKENIZERS_TRY
  ...
  static char* kwlist[] = {const_cast<char*>("sequence"),
                           ...
                           const_cast<char*>("add_special_tokens"), NULL};
  bool flag_ = PyArg_ParseTupleAndKeywords(
      args, kwargs, "|OOOO", kwlist, &kw_sequence, &kw_pair,
      &kw_is_pretokenized, &kw_add_special_tokens);
  Py_ssize_t args_num = PyTuple_Size(args);
  if (args_num >= (Py_ssize_t)1 && args_num <= (Py_ssize_t)4) {
    ...
    if (is_pretokenized) {
      if (PyList_Check(kw_sequence) || PyTuple_Check(kw_sequence)) {
        ...
        self->tokenizer.EncodeSingleString(sequence_array, 0,
                                           core::OffsetType::CHAR, &encoding);
        ...
        self->tokenizer.PostProcess(&encoding, pair_encoding_ptr,
                                    add_special_tokens, &result_encoding);
      } else {
        // throw error
        std::ostringstream oss;
      ...
      self->tokenizer.EncodeSingleString(sequence, 0, core::OffsetType::CHAR,
                                         &encoding);
      core::Encoding* pair_encoding_ptr = nullptr;
      if (has_pair) {
        self->tokenizer.EncodeSingleString(pair, 1, core::OffsetType::CHAR,
                                           &pair_encoding);
        pair_encoding_ptr = &pair_encoding;
      }
      self->tokenizer.PostProcess(&encoding, pair_encoding_ptr,
...
static PyObject* EncodeBatch(TokenizerObject* self, PyObject* args,
                             PyObject* kwargs) {
  TOKENIZERS_TRY
  ...
  static char* kwlist[] = {const_cast<char*>("input"),
                           ...
                           const_cast<char*>("is_pretokenized"), NULL};
  bool flag_ =
      PyArg_ParseTupleAndKeywords(args, kwargs, "|OOO", kwlist, &kw_input,
                                  &kw_special_tokens, &kw_is_pretokenized);
  bool add_special_tokens = true;
  bool is_pretokenized = false;
  Py_ssize_t args_num = PyTuple_Size(args);
  VLOG(6) << " args_num: " << args_num << ", flag_kwargs: " << flag_kwargs
  ...
  if (args_num >= (Py_ssize_t)1 && args_num <= (Py_ssize_t)3) {
    ...
    self->tokenizer.EncodeBatchStrings(batch_encode_input, &result_encodings,
                                       add_special_tokens);
...
// def id_to_token(id)
static PyObject* IdToToken(TokenizerObject* self, PyObject* args,
                           PyObject* kwargs) {
  PyObject* kw_id = NULL;
...
static PyObject* TokenToId(TokenizerObject* self, PyObject* args,
                           PyObject* kwargs) {
  TOKENIZERS_TRY
...
static PyObject* NumSpecialTokensToAdd(TokenizerObject* self, PyObject* args,
                                       PyObject* kwargs) {
  TOKENIZERS_TRY
...
static PyObject* Save(TokenizerObject* self, PyObject* args, PyObject* kwargs) {
  ...
  static char* kwlist[] = {const_cast<char*>("path"),
                           const_cast<char*>("pretty"), NULL};
  bool flag_ = PyArg_ParseTupleAndKeywords(args, kwargs, "|OO", kwlist,
                                           &kw_path, &kw_pretty);
  bool pretty = true;
  Py_ssize_t args_num = PyTuple_Size(args);
...
static PyObject* ToStr(TokenizerObject* self, PyObject* args,
                       PyObject* kwargs) {
  TOKENIZERS_TRY
  PyObject* kw_pretty = NULL;
...
static PyObject* FromStr(TokenizerObject* self, PyObject* args,
                         PyObject* kwargs) {
  TOKENIZERS_TRY
...
static PyObject* FromFile(TokenizerObject* self, PyObject* args,
                          PyObject* kwargs) {
  TOKENIZERS_TRY
  PyObject* kw_path = NULL;
  static char* kwlist[] = {const_cast<char*>("json"), NULL};
...
static PyObject* Decode(TokenizerObject* self, PyObject* args,
                        PyObject* kwargs) {
  TOKENIZERS_TRY
  ...
  bool flag_kwargs = false;
  if (kwargs) flag_kwargs = true;
  static char* kwlist[] = {const_cast<char*>("ids"),
                           const_cast<char*>("skip_special_tokens"), NULL};
  bool flag_ = PyArg_ParseTupleAndKeywords(args, kwargs, "|OO", kwlist, &kw_ids,
                                           &kw_skip_special_tokens);
...
static PyObject* DecodeBatch(TokenizerObject* self, PyObject* args,
                             PyObject* kwargs) {
  TOKENIZERS_TRY
...
PyMethodDef tokenizer_variable_methods[] = {
    {"add_special_tokens", (PyCFunction)(void (*)(void))AddSpecialTokens,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"add_tokens", (PyCFunction)(void (*)(void))AddTokens,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"enable_padding", (PyCFunction)(void (*)(void))EnablePadding,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"disable_padding", (PyCFunction)(void (*)(void))DisablePadding,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"enable_truncation", (PyCFunction)(void (*)(void))EnableTruncation,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"disable_truncation", (PyCFunction)(void (*)(void))DisableTruncation,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"get_vocab", (PyCFunction)(void (*)(void))GetVocab,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"get_vocab_size", (PyCFunction)(void (*)(void))GetVocabSize,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"encode", (PyCFunction)(void (*)(void))Encode,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"encode_batch", (PyCFunction)(void (*)(void))EncodeBatch,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"decode", (PyCFunction)(void (*)(void))Decode,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"decode_batch", (PyCFunction)(void (*)(void))DecodeBatch,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"id_to_token", (PyCFunction)(void (*)(void))IdToToken,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"token_to_id", (PyCFunction)(void (*)(void))TokenToId,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"num_special_tokens_to_add",
     (PyCFunction)(void (*)(void))NumSpecialTokensToAdd,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"save", (PyCFunction)(void (*)(void))Save, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"to_str", (PyCFunction)(void (*)(void))ToStr, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"from_str", (PyCFunction)(void (*)(void))FromStr,
     METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
    {"from_file", (PyCFunction)(void (*)(void))FromFile,
     METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
...
void BindTokenizers(pybind11::module* m) {
  ...
  Py_INCREF(type);
  if (PyModule_AddObject(m->ptr(), "Tokenizer",
