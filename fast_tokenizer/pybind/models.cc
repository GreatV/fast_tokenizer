...
class PyModel : public models::Model {
 public:
  ...
  virtual std::vector<core::Token> Tokenize(
    ...
    PYBIND11_OVERLOAD_PURE_NAME(std::vector<core::Token>, Model, "tokenize",
                                Tokenize, tokens);
  }

  virtual bool TokenToId(const std::string& token,
                         uint32_t* id) const override {
    PYBIND11_OVERLOAD_PURE_NAME(bool, Model, "token_to_id", TokenToId, token,
                                id);
  }

  virtual bool IdToToken(uint32_t id, std::string* token) const override {
    PYBIND11_OVERLOAD_PURE_NAME(bool, Model, "id_to_token", IdToToken, id,
                                token);
  }
  ...
  virtual std::vector<std::string> Save(
    ...
    PYBIND11_OVERLOAD_PURE_NAME(std::vector<std::string>, Model, "save", Save,
...
class PyWordPiece : public models::WordPiece {
  ...
  virtual std::vector<core::Token> Tokenize(
      const std::string& tokens) override {
    PYBIND11_OVERLOAD_NAME(std::vector<core::Token>, WordPiece, "tokenize",
                           Tokenize, tokens);
  }

  virtual bool TokenToId(const std::string& token,
                         uint32_t* id) const override {
    PYBIND11_OVERLOAD_NAME(bool, WordPiece, "token_to_id", TokenToId, token,
                           id);
  }

  virtual bool IdToToken(uint32_t id, std::string* token) const override {
    PYBIND11_OVERLOAD_NAME(bool, WordPiece, "id_to_token", IdToToken, id,
                           token);
  }
  ...
  virtual std::vector<std::string> Save(
      const std::string& folder,
      const std::string& filename_prefix) const override {
    PYBIND11_OVERLOAD_NAME(std::vector<std::string>, WordPiece, "save", Save,
                           folder, filename_prefix);
  }
};
...
class PyFastWordPiece : public models::FastWordPiece {
  ...
  virtual std::vector<core::Token> Tokenize(
      const std::string& tokens) override {
    PYBIND11_OVERLOAD_NAME(std::vector<core::Token>, FastWordPiece, "tokenize",
                           Tokenize, tokens);
  }

  virtual bool TokenToId(const std::string& token,
                         uint32_t* id) const override {
    PYBIND11_OVERLOAD_NAME(bool, FastWordPiece, "token_to_id", TokenToId, token,
                           id);
  }

  virtual bool IdToToken(uint32_t id, std::string* token) const override {
    PYBIND11_OVERLOAD_NAME(bool, FastWordPiece, "id_to_token", IdToToken, id,
                           token);
  }
  ...
  virtual size_t GetVocabSize() const override {
    PYBIND11_OVERLOAD_NAME(size_t, FastWordPiece, "get_vocab_size",
                           GetVocabSize);
  }
  ...
  virtual std::vector<std::string> Save(
      const std::string& folder,
      const std::string& filename_prefix) const override {
    PYBIND11_OVERLOAD_NAME(std::vector<std::string>, FastWordPiece, "save",
                           Save, folder, filename_prefix);
  }
};
...
class PyBPE : public models::BPE {
  ...
  virtual std::vector<core::Token> Tokenize(
      const std::string& tokens) override {
    PYBIND11_OVERLOAD_NAME(std::vector<core::Token>, BPE, "tokenize", Tokenize,
                           tokens);
  }
  ...
  virtual std::vector<std::string> Save(
      const std::string& folder,
      const std::string& filename_prefix) const override {
    PYBIND11_OVERLOAD_NAME(std::vector<std::string>, BPE, "save", Save, folder,
                           filename_prefix);
  }
};
...
class PyUnigram : public models::Unigram {
  ...
  virtual std::vector<core::Token> Tokenize(
      const std::string& tokens) override {
    PYBIND11_OVERLOAD_NAME(std::vector<core::Token>, Unigram, "tokenize",
                           Tokenize, tokens);
  }
  ...
  virtual std::vector<std::string> Save(
      const std::string& folder,
      const std::string& filename_prefix) const override {
    PYBIND11_OVERLOAD_NAME(std::vector<std::string>, Unigram, "save", Save,
                           folder, filename_prefix);
  }
};
...
void BindModels(pybind11::module* m) {
  ...
  py::class_<models::WordPiece, PyWordPiece>(submodule, "WordPiece")
      .def(py::init<>())
      .def(py::init<const core::Vocab&, const std::string&, size_t,
                    const std::string&, bool>(),
           py::arg("vocab"), py::arg("unk_token") = "[UNK]",
      ...
      .def_static("read_file", &models::WordPiece::GetVocabFromFile,
                  py::arg("vocab"))
      .def_static("from_file", &models::WordPiece::GetWordPieceFromFile,
                  py::arg("vocab"), py::arg("unk_token") = "[UNK]",
                  py::arg("max_input_chars_per_word") = 100,
                  py::arg("continuing_subword_prefix") = "##")
      .def(
          "save",
          [](const models::WordPiece& wordpiece, const std::string& folder,
          ...
          py::arg("folder"), py::arg("prefix") = py::none());
  py::class_<models::FastWordPiece, PyFastWordPiece>(submodule, "FastWordPiece")
      ...
      .def_static("read_file", &models::FastWordPiece::GetVocabFromFile,
                  py::arg("vocab"))
      .def_static("from_file", &models::FastWordPiece::GetFastWordPieceFromFile,
                  py::arg("vocab"), py::arg("unk_token") = "[UNK]",
                  py::arg("max_input_chars_per_word") = 100,
                  py::arg("continuing_subword_prefix") = "##",
                  py::arg("with_pretokenization") = false)
      .def(
          "save",
          [](const models::FastWordPiece& wordpiece, const std::string& folder,
             const py::object& py_obj) {
            std::string prefix = "";
            if (!py_obj.is(py::none())) {
              prefix = py_obj.cast<std::string>();
  ...
  py::class_<models::BPE, PyBPE>(submodule, "BPE")
      .def(py::init([](const py::object& py_vocab, const py::object& py_merges,
             ...
             models::BPE self(vocab, merges, cache_capacity, dropout, unk_token,
                              continuing_subword_prefix, end_of_word_suffix,
                              fuse_unk);
             return self;
           }),
           py::arg("vocab") = py::none(), py::arg("merges") = py::none(),
           py::arg("cache_capacity") = py::none(),
           py::arg("dropout") = py::none(), py::arg("unk_token") = py::none(),
      ...
      .def(
          "save",
          [](const models::BPE& bpe, const std::string& folder,
             const py::object& py_obj) {
            std::string prefix = "";
            if (!py_obj.is(py::none())) {
              prefix = py_obj.cast<std::string>();
      ...
      .def_static(
          ...
          [](const std::string& vocab_path, const std::string& merges_path) {
            core::Vocab vocab;
            core::Merges merges;
            models::BPE::GetVocabAndMergesFromFile(vocab_path, merges_path,
                                                   &vocab, &merges);
      ...
      .def_static(
          ...
          [](const std::string& vocab_path, const std::string& merges_path,
            ...
            return models::BPE(vocab, merges, cache_capacity, dropout,
  ...
  py::class_<models::Unigram, PyUnigram>(submodule, "Unigram")
      .def(py::init([](const py::object& py_vocab_list,
           ...
           py::arg("vocab") = py::none(), py::arg("unk_id") = py::none())
      ...
      .def("set_filter_token", &models::Unigram::SetFilterToken,
           py::arg("filter_token") = "")
      .def("set_split_rule", &models::Unigram::SetSplitRule,
           py::arg("split_rule") = "")
      .def(
          "save",
          [](const models::Unigram& unigram, const std::string& folder,
             const py::object& py_obj) {
            std::string prefix = "";
            if (!py_obj.is(py::none())) {
              prefix = py_obj.cast<std::string>();
