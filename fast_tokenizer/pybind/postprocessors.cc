...
class PyPostProcessor : public postprocessors::PostProcessor {
 public:
  ...
  virtual void operator()(core::Encoding* encoding,
    ...
    PYBIND11_OVERLOAD_PURE_NAME(void, PostProcessor, "__call__", operator(),
                                encoding, pair_encoding, add_special_tokens,
                                result_encoding);
  }
  virtual size_t AddedTokensNum(bool is_pair) const override {
    PYBIND11_OVERLOAD_PURE_NAME(size_t, PostProcessor,
                                "num_special_tokens_to_add", AddedTokensNum,
                                is_pair);
  }
};
...
class PyBertPostProcessor : public postprocessors::BertPostProcessor {
 public:
  ...
  virtual void operator()(core::Encoding* encoding,
                          ...
                          bool add_special_tokens,
                          core::Encoding* result_encoding) const override {
    PYBIND11_OVERLOAD_NAME(void, BertPostProcessor, "__call__", operator(),
                           encoding, pair_encoding, add_special_tokens,
                           result_encoding);
  }
  virtual size_t AddedTokensNum(bool is_pair) const override {
    PYBIND11_OVERLOAD_NAME(size_t, BertPostProcessor,
                           "num_special_tokens_to_add", AddedTokensNum,
                           is_pair);
  }
};
...
class PyTemplatePostProcessor : public postprocessors::TemplatePostProcessor {
 public:
  ...
  virtual void operator()(core::Encoding* encoding,
                          ...
                          bool add_special_tokens,
                          core::Encoding* result_encoding) const override {
    PYBIND11_OVERLOAD_NAME(void, TemplatePostProcessor, "__call__", operator(),
                           encoding, pair_encoding, add_special_tokens,
                           result_encoding);
  }
  virtual size_t AddedTokensNum(bool is_pair) const override {
    PYBIND11_OVERLOAD_NAME(size_t, TemplatePostProcessor,
                           "num_special_tokens_to_add", AddedTokensNum,
                           is_pair);
  }
};
...
class PyRobertaPostProcessor : public postprocessors::RobertaPostProcessor {
 public:
  ...
  virtual void operator()(core::Encoding* encoding,
                          ...
                          bool add_special_tokens,
                          core::Encoding* result_encoding) const override {
    PYBIND11_OVERLOAD_NAME(void, RobertaPostProcessor, "__call__", operator(),
                           encoding, pair_encoding, add_special_tokens,
                           result_encoding);
  }
  virtual size_t AddedTokensNum(bool is_pair) const override {
    PYBIND11_OVERLOAD_NAME(size_t, RobertaPostProcessor,
                           "num_special_tokens_to_add", AddedTokensNum,
                           is_pair);
  }
};
...
class PyByteLevelPostProcessor : public postprocessors::ByteLevelPostProcessor {
 public:
  ...
  virtual void operator()(core::Encoding* encoding,
                          ...
                          bool add_special_tokens,
                          core::Encoding* result_encoding) const override {
    PYBIND11_OVERLOAD_NAME(void, ByteLevelPostProcessor, "__call__", operator(),
                           encoding, pair_encoding, add_special_tokens,
                           result_encoding);
  }
  virtual size_t AddedTokensNum(bool is_pair) const override {
    PYBIND11_OVERLOAD_NAME(size_t, ByteLevelPostProcessor,
                           "num_special_tokens_to_add", AddedTokensNum,
                           is_pair);
  }
};
...
void BindPostProcessors(pybind11::module* m) {
  ...
  py::class_<postprocessors::PostProcessor, PyPostProcessor>(submodule,
      ...
      .def("num_special_tokens_to_add",
           &postprocessors::PostProcessor::AddedTokensNum, py::arg("is_pair"))
      .def(
          "__call__",
          [](const postprocessors::PostProcessor& self,
             core::Encoding* encoding, core::Encoding* pair_encoding,
             bool add_special_tokens) {
            core::Encoding result_encoding;
            self(encoding, pair_encoding, add_special_tokens, &result_encoding);
            return result_encoding;
          },
          py::arg("encoding"), py::arg("pair_encoding"),
  ...
  py::class_<postprocessors::SpecialToken>(submodule, "SpecialToken")
      ...
      .def(py::init<const std::string&, const std::vector<uint32_t>&,
           ...
           py::arg("id"), py::arg("ids"), py::arg("tokens"))
      .def(py::init<const std::string&, uint32_t>(), py::arg("token"),
           py::arg("id"));
  ...
  py::class_<postprocessors::TemplatePostProcessor, PyTemplatePostProcessor>(
      ...
      .def(
          py::init([](const py::object& single_obj, const py::object& pair_obj,
          ...
          py::arg("single"), py::arg("pair"), py::arg("special_tokens"))
      .def("num_special_tokens_to_add",
  ...
  py::class_<postprocessors::RobertaPostProcessor, PyRobertaPostProcessor>(
      ...
      .def(py::init<>())
      .def(py::init<const std::pair<std::string, uint32_t>&,
                    const std::pair<std::string, uint32_t>&, bool, bool>(),
           py::arg("sep"), py::arg("cls"), py::arg("trim_offsets") = true,
  ...
  py::class_<postprocessors::ByteLevelPostProcessor, PyByteLevelPostProcessor>(
      ...
      .def(py::init<bool, bool, bool>(), py::arg("add_prefix_space") = true,
           py::arg("trim_offsets") = true, py::arg("use_regex") = true)
      .def("num_special_tokens_to_add",
