...
class PyNormalizer : public normalizers::Normalizer {
 public:
  ...
  virtual void operator()(
    ...
    PYBIND11_OVERLOAD_PURE_NAME(void, Normalizer, "__call__", operator(),
                                mut_str);
  }
};
...
class PyBertNormalizer : public normalizers::BertNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, BertNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyReplaceNormalizer : public normalizers::ReplaceNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, ReplaceNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyStripNormalizer : public normalizers::StripNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, StripNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyStripAccentsNormalizer : public normalizers::StripAccentsNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, StripAccentsNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyNFCNormalizer : public normalizers::NFCNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, NFCNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyNFKCNormalizer : public normalizers::NFKCNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, NFKCNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyNFDNormalizer : public normalizers::NFDNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, NFDNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyNFKDNormalizer : public normalizers::NFKDNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, NFKDNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyNmtNormalizer : public normalizers::NmtNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, NmtNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PySequenceNormalizer : public normalizers::SequenceNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, SequenceNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyLowercaseNormalizer : public normalizers::LowercaseNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, LowercaseNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
class PyPrecompiledNormalizer : public normalizers::PrecompiledNormalizer {
 public:
  ...
  virtual void operator()(
      normalizers::NormalizedString* mut_str) const override {
    PYBIND11_OVERLOAD_NAME(void, PrecompiledNormalizer, "__call__", operator(),
                           mut_str);
  }
};
...
void BindNormalizers(pybind11::module* m) {
  ...
  py::class_<normalizers::BertNormalizer, PyBertNormalizer>(submodule,
                                                            "BertNormalizer")
      .def(py::init<bool, bool, bool, bool>(), py::arg("clean_text") = true,
           py::arg("handle_chinese_chars") = true,
           py::arg("strip_accents") = true, py::arg("lowercase") = true)
      .def(py::init([](bool clean_text, bool handle_chinese_chars,
                       const py::object& strip_accents_obj, bool lowercase) {
           ...
           py::arg("clean_text") = true, py::arg("handle_chinese_chars") = true,
           py::arg("strip_accents") = true, py::arg("lowercase") = true)
      .def(
          "normalize_str",
  ...
  py::class_<normalizers::StripNormalizer, PyStripNormalizer>(submodule,
                                                              "StripNormalizer")
      .def(py::init<bool, bool>(), py::arg("left") = true,
           py::arg("right") = true)
      .def(
          "normalize_str",
